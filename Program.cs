...
comando.CommandText = @"
    ...
    CREATE TABLE IF NOT EXISTS FacturaItemHistorico(
...
try
{
    var cmdMigracion = conexion.CreateCommand();
    cmdMigracion.CommandText = "ALTER TABLE Factura ADD COLUMN EsArchivada INTEGER DEFAULT 0;";
